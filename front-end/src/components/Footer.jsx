export default function Footer() {
    return (
        <>
            ...
            <footer className="flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b from-orange-400 to-orange-500 text-white/70">
               
                <p className="mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">Robo Tech Future</a>. All rights reservered.</p>
