export default function Footer() {
    return (
        <>
            ...
            <footer className=" bg-[#CB6CE6]  flex flex-col items-center justify-center w-full py-20 bg-gradient-to-b ">
               
                <p className="  text-white font-bold mt-4 text-center">Copyright © 2025 <a href="https://prebuiltui.com">Robo Tech Future</a>. All rights reservered.</p>
